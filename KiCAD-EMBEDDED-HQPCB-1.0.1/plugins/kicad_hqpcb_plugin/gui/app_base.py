from kicad_hqpcb_plugin.language.lang_const import LANG_DOMAIN
from kicad_hqpcb_plugin.settings.supported_layer_count import AVAILABLE_LAYER_COUNTS
import builtins
import sys
import os
from kicad_hqpcb_plugin import PLUGIN_ROOT
from kicad_hqpcb_plugin.kicad.board_manager import load_board_manager
from kicad_hqpcb_plugin.utils.combo_box_ignore_wheel import ComboBoxIgnoreWheel
...
class BaseApp(wx.EvtHandler):
    ...
    def calling_interface(self):
        from kicad_hqpcb_plugin.gui.main_interface import MainInterface
        self.main_interface = MainInterface(self.board_manager)
        # self.main_interface.pcb_on_place_order()
        # self.main_interface.smt_on_update_price()
        # self.main_interface.smt_on_place_order()

    def startup_dialog(self):
        from kicad_hqpcb_plugin.gui.main_frame import MainFrame
        from kicad_hqpcb_plugin.settings.setting_manager import SETTING_MANAGER
