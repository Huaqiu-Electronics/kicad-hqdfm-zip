...
import requests
import wx.dataview
from kicad_hqpcb_plugin.kicad_nextpcb_new.events import AssignPartsEvent, UpdateSetting
from kicad_hqpcb_plugin.kicad_nextpcb_new.helpers import HighResWxSize, loadBitmapScaled
