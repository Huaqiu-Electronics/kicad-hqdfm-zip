...
import requests
import wx.dataview
from kicad_search_plugin.kicad_nextpcb_new.events import AssignPartsEvent
from kicad_search_plugin.kicad_nextpcb_new.helpers import loadBitmapScaled
...
class PartSelectorframe( wx.Frame ):
    def __init__(self, parent=None):
        ...
        self.parent = parent
        parts ={'C4': '0,C_Disc_D5.1mm_W3.2mm_P5.00mm,,'}
        self.parts = parts
