...
class DfmAnalysis:
                ...
                for item_info_info in item_info_info_list:
                    try:
                        ...
                        if dfm_show_layer == "Top Copper":
                            item_layer_list.append( self.board.GetLayerName(0) )
                        elif dfm_show_layer == "Bot Copper":
                            item_layer_list.append( self.board.GetLayerName(2) )
                        elif dfm_show_layer != "":
                        ...
                        print(f"Error processing item_info_info: {e}")
                        continue
    ...
    def anaylsis_dfm_type_info(
        ...
        try:
            ...
            logging.error(f"Error in anaylsis_dfm_type_info: {e}")
            return []
